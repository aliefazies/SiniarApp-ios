...
class MainViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.playerProviderNowPlayingInfoDidChange), name: .PlayerProviderNowPlayingInfoDidChange, object: nil)
    }
    ...
    func setup() {
        ...
        playerView.backgroundColor = .Siniar.brand1
        ...
        label.textColor = .Siniar.neutral3
        ...
        previousButton.tintColor = .Siniar.neutral1
        ...
        playButton.tintColor = .Siniar.neutral1
        ...
        nextButton.tintColor = .Siniar.neutral1
        ...
        progressView.backgroundColor = .Siniar.brand2
